...
subtitle: "Insights from economics, criminology and psychology research"
date: "2022-07-31"
summary: The ability to read the mind of criminals for sure sounds exciting. However, as exciting as it may sound, assessing anyone’s decision-making processes is not the most straightforward task. This post will give a brief overview of the behavioral economics, psychology, and criminology literature on offenders’ decision-making. It will be discussed whether actions of crime can be considered rational and whether social influence plays a role in criminal behavior.
image:
...
tags: ["Psychology", "Criminology", "Behavioral Economics", "Literature Review"]
---
...
- [Playing Games with Offenders](#playing-games-with-offenders)
- [Behavioral Economics Models](#behavioral-economics-models)
   - [Rational Choice and Expected Utility Theory](#rational-choice-and-expected-utility-theory)
...
* **Iowa Gambling Task (IGT)**: The IGT measures decision-making under uncertainty. Individuals choose from four decks of cards, which differ in their reward-punishment profiles. Two decks are advantageous and result in an overall high reward. Two other decks are disadvantageous and result in more significant losses.
...
In this case $\mathbb{E} \big[ U(X_2) \big] > \mathbb{E} \big[ U(X_1) \big]$, so the rational actor would still choose to play regardless of the proposed amount in the case of Heads.
